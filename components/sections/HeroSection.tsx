    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto pt-24 pb-16">
        ...
        >
          <a
            href="#install"
            className="group flex items-center gap-2 px-7 py-3.5 rounded-xl bg-gradient-to-r from-[#7c3aed] to-[#6d28d9] text-white font-semibold text-base hover:opacity-90 transition-opacity shadow-xl shadow-purple-900/40"
          >
          ...
          <a
            ...
            className="flex items-center gap-2 px-7 py-3.5 rounded-xl border border-[#3a3a5a] text-[#f0f0ff] font-semibold text-base hover:border-[#7c3aed] hover:bg-[#1a1a24] transition-all"
          >
